...
import { ToastifyContainer, toastShow, toastSuccess, toastError, toastInfo } from '@/src/components/Toastify'

type ToastType = 'success' | 'error' | 'info'

interface ToastContextType {
  show: (message: string, type?: ToastType, options?: { title?: string; duration?: number }) => void
...
export function ToastProvider({ children }: { readonly children: React.ReactNode }) {
  const show = useCallback<ToastContextType['show']>((message, type, options) => {
