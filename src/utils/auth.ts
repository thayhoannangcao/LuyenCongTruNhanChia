// Central client-safe auth utilities
export type { AuthUser } from '@/src/types/types';
export type {
  SignUpData,
  SignInData,
...
// Re-export functions from backend API
// Keep this as a thin client-safe proxy; avoid importing server-only code here
...
export async function signIn(data: SignInData) {
  try {
    ...
    const clientId = (function getOrCreateClientId(): string {
